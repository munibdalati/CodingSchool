...
adminSchema.statics.login = async function (email, password, isAdmin = false) {
  //validation
...
adminSchema.statics.addUser = async function (
  username,
  email,
  password,
  role = "admin"
...
// ----------------- Forgot Password -----------------
adminSchema.statics.forgot = async function (email) {
  //validation
  if (!email) {
    throw Error("All fields must be filled");
  }
